...
def load_custom_css():
    st.markdown("""
        ...
        .stChatInput textarea:focus {
            ...
            box-shadow: 0 4px 25px rgba(25, 118, 210, 0.2) !important;
...
# The rest of the Python code remains the same as before
suggested_questions = {
...
def display_suggested_questions():
    ...
    # Create a container for suggested questions with enhanced layout
    with st.container():
...
def handle_suggested_question(question):
    """Handle suggested question selection with typing animation"""
...
def display_typing_animation():
    """Display typing animation while processing"""
    if st.session_state.typing_animation:
        st.markdown("""
...
def main():
    ...
    # Display chat history with smooth scrolling
    if st.session_state.chat_history:
        display_chat()
    
    # Display typing animation if active
    ...
    if user_input:
        # Set typing animation and add message
        st.session_state.typing_animation = True
